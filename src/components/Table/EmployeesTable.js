                    ...
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="right">
                                <TableSortLabel active={valueToOrderBy === "start_date"}
                                                direction={valueToOrderBy === "start_date" ? orderDirection : 'asc'}
                                                onClick={createSortHandler('start_date')}>Start
                                    Date</TableSortLabel>
                            </TableCell>
                            <TableCell align="right">
                                <TableSortLabel active={valueToOrderBy === "department"}
                                                direction={valueToOrderBy === "department" ? orderDirection : 'asc'}
                                                onClick={createSortHandler('department')}>Department</TableSortLabel></TableCell>
                            <TableCell align="right">
                                <TableSortLabel active={valueToOrderBy === "date_of_birth"}
                                                direction={valueToOrderBy === "date_of_birth" ? orderDirection : 'asc'}
                                                onClick={createSortHandler('date_of_birth')}>Date of
                                    Birth</TableSortLabel>
                            </TableCell>
                            <TableCell align="right">
                                <TableSortLabel active={valueToOrderBy === "street"}
                                                direction={valueToOrderBy === "street" ? orderDirection : 'asc'}
                                                onClick={createSortHandler('street')}>Street</TableSortLabel>
                            </TableCell>
                            <TableCell align="right">
                                <TableSortLabel active={valueToOrderBy === "city"}
                                                direction={valueToOrderBy === "city" ? orderDirection : 'asc'}
                                                onClick={createSortHandler('city')}>City</TableSortLabel>
                            </TableCell>
                            <TableCell align="right">
                                <TableSortLabel active={valueToOrderBy === "state"}
                                                direction={valueToOrderBy === "state" ? orderDirection : 'asc'}
                                                onClick={createSortHandler('state')}>State</TableSortLabel>
                            </TableCell>
                            <TableCell align="right">
                                <TableSortLabel active={valueToOrderBy === "zip_code"}
                                                direction={valueToOrderBy === "zip_code" ? orderDirection : 'asc'}
                                                onClick={createSortHandler('zip_code')}>Zip
                                    Code</TableSortLabel>
                            </TableCell>
                        </TableRow>
                    </TableHead>
                    ...
                    <TableBody>
                        {
                            sortedRowInformation(rowInformation, getComparator(orderDirection, valueToOrderBy))
                                ...
                                .map((person, index) => (
                                    ...
                                    >
                                        <TableCell component="th" scope="row">{person.first_name}
                                        </TableCell>
